...
let para = "mi niña ermosha"; // valor por defecto
let mensaje = `Mi niña, hay tantas cosas bonitas que quiero decirte porque sin duda tú mereces todo lo bonito del mundo...
Estuve pensando qué hice para tener a mi lado a una persona tan increible como tú, aunque hice una idiotez, y te lastime... seguire peleando por ti, y eso es por que te amo y algun dia espero me perdones y seamos ese ekuipo que superara todo juntos.
cada vez que me llega un mensaje tuyo me pone muy feliz aunque hablemos poco todo el día, tus mensajes me  ponen tan feliz que por poco lloro por alegría, eres y será siempre mi persona favorita, me gusta todo de ti , eres una persona maravillosa increíble y no quiero que dejes que alguien te diga lo contrario.❤️🥰Gracias por hacerme la persona más feliz del mundo... no sé cómo describir lo que siento por ti, un simple te amo no es suficiente en serio mi niñaa, te agradezco por todo. 
...
eres mi persona  más importante en este mundo, mi corazón es completamente tuyo, por último mi niña... estoy orgulloso de ti.
Sin duda alguna... te amo❤️`;
...
let loadingText = "Para ti angiesita <3"; // valor por defecto para loading
